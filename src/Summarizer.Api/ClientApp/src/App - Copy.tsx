  ...
  return (
    <div className="mt-3 grid gap-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ClipboardButton text={typeof result === "string" ? result : (result?.summaryText || text)} />
          <DownloadJsonButton data={result} />
        </div>
      </div>

      {result?.title && <p className="text-sm text-gray-500 dark:text-gray-400">{result.title}</p>}
